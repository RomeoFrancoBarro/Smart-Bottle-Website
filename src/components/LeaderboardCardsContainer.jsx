...
const LeaderboardCardsContainer = () => {
    ...
    return (
        ...
        {tableData.map((row, index) => (
            ...
            {row.key === "COEng" && (
            <div className="w-full md:w-7/12  p-3 pr-6 pl-6 md:p-4 ">
                {/* Metric Card */}
                <div className="bg-gradient-to-b from-green-200 to-green-100 border-b-4 border-green-600 rounded-lg shadow-xl p-4 md:p-8">
                    <div className="flex flex-row items-center">
                        <div className="flex-shrink pr-4">
                            <div className="rounded-full p-3 pr-4 pl-4 bg-green-600">
                            <i className={`fas fa-${index} fa-2x fa-inverse`}></i>
                            </div>
                        </div>
                        
                        <div className="flex-1 text-center md:text-center">
                            <p className="font-bold text-2xl">College of Engineering </p>
                        </div>
            ...
            <div className="w-full md:w-7/12 p-3 pr-6 pl-6 md:p-4">
                ...
                <div className="bg-gradient-to-b from-pink-200 to-pink-100 border-b-4 border-pink-500 rounded-lg shadow-xl p-4 md:p-8">
                    <div className="flex flex-row items-center">
                        <div className="flex-shrink pr-4">
                            <div className="rounded-full p-3 pr-4 pl-4 bg-pink-600">
                            <i className={`fas fa-${index} fa-2x fa-inverse`}></i>
                            </div>
                        </div>
              
                        <div className="flex-1 text-center md:text-center">
                            <p className="font-bold text-2xl">College of Education </p>
                        </div>
            ...
            <div className="w-full md:w-7/12  p-3 pr-6 pl-6 md:p-4">
                ...
                <div className="bg-gradient-to-b from-yellow-200 to-yellow-100 border-b-4 border-yellow-600 rounded-lg shadow-xl p-4 md:p-8">
                    <div className="flex flex-row items-center">
                        <div className="flex-shrink pr-4">
                            <div className="rounded-full p-3 pr-4 pl-4 bg-yellow-600">
                            <i className={`fas fa-${index} fa-2x fa-inverse`}></i>
                            </div>
                        </div>

                        <div className="flex-1 text-center md:text-center">
                            <p className="font-bold text-2xl">College of Science</p>
                        </div>
            ...
            {row.key === "CIT" && (
            <div className="w-full md:w-7/12  p-3 pr-6 pl-6 pb-4 md:p-4">
                {/* Metric Card */}
                <div className="bg-gradient-to-b from-indigo-200 to-indigo-100 border-b-4 border-indigo-500 rounded-lg shadow-xl p-4 md:p-8">
                    <div className="flex flex-row items-center">
                        <div className="flex-shrink pr-4">
                            <div className="rounded-full p-3 pr-4 pl-4 bg-indigo-600">
                            <i className={`fas fa-${index} fa-2x fa-inverse`}></i>
                            </div>
                        </div>
                        
                        <div className="flex-1 text-center md:text-center">
                            <p className="font-bold text-2xl">College Of Industrial Technology</p>
                        </div>

                        <div className="flex-shrink pl-4">
                            <div className="rounded-full p-3 bg-indigo-600">
